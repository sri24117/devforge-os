...
from app.api.routes import (
    ...
    system_design, projects, auth, ai, execution, roadmap, assistant, focus, entitlements, market_ready, v6_production, payments, admin
)
...
app.include_router(market_ready.router,    prefix="/api/v5",           tags=["Market Ready V5"])
app.include_router(v6_production.router,  prefix="/api/v6",           tags=["Production V6"])
app.include_router(payments.router,       prefix="/api/payments",     tags=["Razorpay Payments V7"])
...
async def health_check():
    return {"status": "ok", "service": "devforge-api", "version": "7.0.0"}
