...
class Settings(BaseSettings):
    ...
    EXECUTION_STRICT_LIMITS: bool = False  # local/dev reliability; use Judge0/Docker for public memory isolation

    # V6 production integrations
    EXECUTION_BACKEND: str = "local"  # local | docker | judge0
    ...
    RAZORPAY_COMPANY_NAME: str = "DevForge OS"
    FRONTEND_URL: str = "http://localhost:5173"

    STARTER_PRICE_INR: int = 199
    PRO_PRICE_INR: int = 499
    PREMIUM_PRICE_INR: int = 999
    LIFETIME_PRICE_INR: int = 2499
